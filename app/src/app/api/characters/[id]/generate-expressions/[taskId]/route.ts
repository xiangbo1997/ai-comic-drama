...
const log = createLogger("api:characters:expressions:status");
...
/**
 * GET /api/characters/[id]/generate-expressions/[taskId]
 * 轮询表情集生成任务状态。鉴权：task.input.userId 必须匹配当前 session。
 */
export async function GET(_request: NextRequest, { params }: RouteParams) {
  try {
    ...
    log.error("Expressions status error:", error);
